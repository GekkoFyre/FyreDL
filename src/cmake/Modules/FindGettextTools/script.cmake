...
# Modifications made in this section just below by Phobos Aryn'dythyrn D'thorga of GekkoFyre
# for the open-source project, 'Gecho', an XMPP instant messager with encryption in mind.
execute_process(COMMAND ${XGETTEXT_EXECUTABLE}
  "--output=${potFile}"
  "--omit-header" "--language=C++" "--boost" "--add-comments"
  ${keywordArgs}
  ${sourceFiles}
